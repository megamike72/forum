...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'vdhhaksm_admin', 'forum2712', 'vdhhaksm_forum', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'vdhhaksm_admin',
            'dbal.dbpasswd' => 'forum2712',
            'dbal.dbname' => 'vdhhaksm_forum',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
